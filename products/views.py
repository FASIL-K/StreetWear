...
def add_product(request):
    ...
    if request.method == 'POST':
        ...
        product.save()
        return redirect('product_management')
    return render(request,'adminside/product/product_management.html')
...
def edit_product(request, editproduct_id):
    ...
    if request.method == "POST":
        ...
        # Retrieve the brand and category objects
        brand_obj = Brand.objects.get(name=brandname)
        category_obj = Category.objects.get(id=category_id)

        # Update the brand and category fields of the product
